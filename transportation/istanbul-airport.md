...
Head to the floor below for luggage. To find which carousel your bag is on, scan the barcode on your ticket with the iGA Istanbul Airport app.

- App: https://play.google.com/store/apps/details?id=com.igasystem.iga

## Exiting

Customs officers near the exit may ask you to open your luggage — they didn't stop me. Full maps are posted near the exit — look for **Çıkış** signs. Use those to find your transport type and platform.

## Getting to the City

Cash is not accepted for public transport — you need an **Istanbul Card** or a bank card.

- In the arrivals hall there are Ziraat Bank branches and currency exchange booths
- Istanbul Card: see [Istanbulkart — Getting the Card](istanbulkart.md#getting-the-card) for where to get one; you can charge it at any exchange booth in the arrivals hall.
