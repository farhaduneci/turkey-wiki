...
3. **First week** — [Turkish Tax Number](banking/tax-number.md) → [Opening a Bank Account](banking/bank-account.md) → [SIM Cards, eSIM & Mobile Data](internet/sim-cards-and-mobile-data.md) → [Free WiFi](internet/free-wifi.md) → [Sahibinden](apps/sahibinden.md) if you're still house-hunting
