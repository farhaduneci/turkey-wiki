...
Instead of letting useful information disappear in chats, bookmarks, and notes, I'm documenting it here—for myself and anyone else who might find it helpful.

## Where to Start

New here and about to move to Turkey? The full index below is organized by topic, but if you don't know where to begin, read in roughly this order instead:
...
4. **File your residence permit application** — check [Closed Neighborhoods](visa/closed-neighborhoods.md) before signing a lease, then [submit your application](visa/address-registration.md#submitting-the-application-itself) and book the follow-up [Address Registration](visa/address-registration.md#book-an-appointment) appointment before your 90 days run out. (Students: your university usually files this for you — see [Finding and Registering at a University](student-life/finding-and-registering-university.md).)
...
6. **Once your residence permit application is open** — this is when a Turkish ID/foreigner ID number exists for you, unlocking [e-Devlet](apps/e-devlet.md) access, [İstanbul Senin App](apps/istanbul-senin-app.md), and the discounted [İstanbulkart App](apps/istanbulkart-app.md) application (see the [Apps](apps/) index — 🪪 marks what needs the ID number)
...
The full topic index, for browsing or coming back to later:
...
Moving to another country comes with a lot of questions, and the answers are often scattered across forums, Reddit posts, Telegram groups, and official websites.

This repository is my attempt to collect everything in one place—based on my experiences.

## Contributing

Found something outdated, incorrect, or missing? Feel free to open an issue or submit a pull request. Contributions are welcome.
