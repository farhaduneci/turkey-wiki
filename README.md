...
4. **File your residence permit application** — check [Closed Neighborhoods](visa/closed-neighborhoods.md) before signing a lease, then submit your application and book the follow-up [Address Registration](visa/address-registration.md#submitting-the-application-itself) appointment before your 90 days run out. (Students: your university usually files this for you — see [Finding and Registering at a University](student-life/finding-and-registering-university.md).)
