...
Mobile apps that are genuinely useful (or necessary) for daily life in Turkey.

🪪 marks apps whose main features need a Turkish ID / foreigner ID number (Yabancı Kimlik Numarası) — meaning you need an active residence permit application before they fully work, not just a Turkish phone number.
